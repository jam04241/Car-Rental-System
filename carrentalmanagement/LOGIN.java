...
public class LOGIN extends javax.swing.JFrame {
    ...
    private void logbtnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_logbtnKeyPressed
        if(usertxt.getText().contentEquals("Cjrent@gmail.com") && passfield.getText().equals("password") && evt.getKeyCode()== KeyEvent.VK_ENTER){
            this.dispose();            
            JOptionPane.showMessageDialog(null, "Welcome [" + usertxt.getText()+ "] To CJ Car Rental Services","Welcome",JOptionPane.INFORMATION_MESSAGE);
            HOME home = new HOME();
            home.setVisible(rootPaneCheckingEnabled);
        }       
        else if(!usertxt.getText().contentEquals("Cjrent@gmail.com") && passfield.getText().equals("password") && evt.getKeyCode()== KeyEvent.VK_ENTER){
